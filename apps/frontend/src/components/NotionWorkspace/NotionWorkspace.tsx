                            ...
                            <div
                                ...
                                onKeyDown={(e: React.KeyboardEvent<HTMLElement>) => {
                                    ...
                                    if (e.key === '/') {
                                        ...
                                        const searchQuery = textContent.substring(1); // Remove the / character
                                        // The SlashCommandMenu will receive this via searchQuery prop
                                    } else if (e.key === 'Backspace') {
                                        // Handle intuitive delete behavior
                                        // Check if cursor is at the beginning and content is empty or will be empty after backspace
                                ...
                                onInput={(e: React.FormEvent<HTMLElement>) => {
                                    const textContent = e.currentTarget.textContent || '';
                                    if (slashCommandOpen && textContent.startsWith('/')) {
                                        // Update search query in real-time as user types
                                        const searchQuery = textContent.substring(1);
                                        // The SlashCommandMenu will receive this via searchQuery prop
                                    }
                                }}
                            >
